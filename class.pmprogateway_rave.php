					...
					<tr class="gateway gateway_rave" <?php if($gateway != "rave") { ?>style="display: none;"<?php } ?>>
						...
						<td>
							<select id="rave_payment_method" name="rave_payment_method">
								<option value="both" <?php if(empty($values['rave_payment_method'])) { ?>selected="selected"<?php } ?>><?php _e('All', 'paid-memberships-pro' );?></option>
								<option value="ussd" <?php if(empty($values['rave_payment_method'])) { ?>selected="selected"<?php } ?>><?php _e('USSD only', 'paid-memberships-pro' );?></option>
								<option value="account" <?php if(!empty($values['rave_payment_method'])) { ?>selected="selected"<?php } ?>><?php _e('Account only', 'paid-memberships-pro' );?></option>
								<option value="card" <?php if(!empty($values['rave_payment_method'])) { ?>selected="selected"<?php } ?>><?php _e('Card only', 'paid-memberships-pro' );?></option>
							</select>
						</td>
					</tr>
					<tr class="gateway gateway_rave" <?php if($gateway != "rave") { ?>style="display: none;"<?php } ?>>
						...
						<td>
							<select id="rave_merchant_country" name="rave_merchant_country">
								<option value="NG" <?php if(empty($values['rave_merchant_country'])) { ?>selected="selected"<?php } ?>><?php _e('Nigeria', 'paid-memberships-pro' );?></option>
								<option value="GH" <?php if(!empty($values['rave_merchant_country'])) { ?>selected="selected"<?php } ?>><?php _e('Ghana', 'paid-memberships-pro' );?></option>
								<option value="KE" <?php if(!empty($values['rave_merchant_country'])) { ?>selected="selected"<?php } ?>><?php _e('Kenya', 'paid-memberships-pro' );?></option>
							</select>
						</td>
					</tr>
					<tr class="gateway gateway_rave" <?php if($gateway != "rave") { ?>style="display: none;"<?php } ?>>
